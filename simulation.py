...
class Main:
    ...
    while True:
        ...
        laneOneText = font.render("Manali High Raod", True, black, white)
        screen.blit(laneOneText, (150, 290))
        laneTwoText = font.render("Moolakadai High Road", True, black, white)
        screen.blit(laneTwoText, (810, 100))
        laneThreeText = font.render("Ambattur Camp Road", True, black, white)
        screen.blit(laneThreeText, (295, 730))
        laneFourText = font.render("CMBT Road", True, black, white)
